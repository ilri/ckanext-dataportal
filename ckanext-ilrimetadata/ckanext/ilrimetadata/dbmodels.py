...
class userModel(Base):
    ...
    def __init__(
        self, user_id, user_name, user_password, user_email, user_org, added_by
    ):
...
class datasetokenModel(Base):
    ...
    token_id = Column(
        Text, ForeignKey("token.token_id"), primary_key=True, nullable=False
    )
...
class usergroupModel(Base):
    ...
    group_id = Column(
        Integer, ForeignKey("authgroup.group_id"), primary_key=True, nullable=False
    )
